...
v-navigation-drawer(v-model="drawer" color="blue-darken-4" theme="dark" :width="200")
  v-list(density="compact" nav)
    ...
    v-list-item(prepend-icon="mdi-account-off" title="Pacientes Inativos" to="/pacientes-inativos")
    v-list-item(prepend-icon="mdi-calendar-check" title="Eventos" to="/events")
    v-list-item(prepend-icon="mdi-hand-heart-outline" title="Registros de Ocorr\u00EAncias" to="/registros-de-ocorrencias")
